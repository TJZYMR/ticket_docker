    ...
    def create(self, request):
        try:
            ...
            with transaction.atomic():
                ...
                #!This is set to 60 seconds But for the real time booking schenerio It should be set to 600 seconds(10 minutes)
                seat_timeout.apply_async((seats, queryset.id, show_id), countdown=60)
